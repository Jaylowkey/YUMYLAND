      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="flex h-16 items-center justify-between">
          ...
          <div className="hidden md:flex md:items-center md:gap-8">
            ...
            <a href="#pricing" className="text-sm font-medium text-gray-600 hover:text-primary-500 transition-colors">
        ...
        {mobileMenuOpen && (
          <div className="md:hidden border-t border-gray-100 py-4 space-y-3">
            <a href="#features" className="block text-sm font-medium text-gray-600 hover:text-primary-500">
              {t("landing.footer.features")}
            </a>
            <a href="#pricing" className="block text-sm font-medium text-gray-600 hover:text-primary-500">
              {t("landing.footer.pricing")}
            </a>
            <Link href={`/${switchLocale}`} className="block text-sm font-medium text-gray-500">
              {switchLocale === "en" ? "🇬🇧 English" : "🇲🇿 Português"}
            </Link>
            <Link href={`/${currentLocale}/login`} className="block text-sm font-medium text-gray-600">
              {t("common.login")}
            </Link>
            <Link href={`/${currentLocale}/register`} className="block btn-primary text-center text-sm">
              {t("common.register")}
            </Link>
          </div>
        )}
